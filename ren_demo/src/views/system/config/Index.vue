<template>
    <el-form ref="searchFormRef" :rules="rules" :inline="true" :model="tableParams" class="demo-form-inline">
        <el-form-item label="查询" prop="searchLike">
            <el-input v-model="tableParams.searchLike" placeholder="参数名称/参数键名" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="tableData" stripe @sort-change="tableSortHandle">
        ...
        <el-table-column prop="configKey" label="参数键名" width="200" show-overflow-tooltip></el-table-column>
        <el-table-column prop="configValue" label="参数键值" width="200" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" min-width="120">
            <template #default="scope">
                <el-button link type="primary" size="small" @click="openModifyConfigDialog(scope.$index, scope.row)" >修改</el-button>
                <el-button link type="primary" size="small" @click="handleDeleteConfig(scope.$index, scope.row)" >删除</el-button>
            </template>
        </el-table-column>
    </el-table>
    <Pagination
        ...
        @pagination="getList"
    />
    <el-dialog :title="addOrModifyTag == 1 ? '添加参数' : '修改参数'" v-model="dialogFormAddOrModifyConfig" width="500px">
        <el-form :model="addOrModifyConfigForm" :rules="addOrModifyConfigFormRules" ref="addOrModifyConfigFormRef">
            <el-form-item label="参数名称" :label-width="addOrModifyConfigFormLabelWidth" prop="configName">
                <el-input v-model="addOrModifyConfigForm.configName" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="参数键名" :label-width="addOrModifyConfigFormLabelWidth" prop="configKey">
                <el-input v-model="addOrModifyConfigForm.configKey" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="参数键值" :label-width="addOrModifyConfigFormLabelWidth" prop="configValue">
                <el-input v-model="addOrModifyConfigForm.configValue" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="是否系统内置" :label-width="addOrModifyConfigFormLabelWidth" prop="isSystem">
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="addOrModifyConfigConfirm(addOrModifyConfigFormRef)">
                    确 定
                </el-button>
            </span>
        </template>
...
<script setup lang="ts" name="config">
    ...
    const addOrModifyConfigFormRules = reactive<FormRules>({
        ...
        configKey:[
            { required: true, message: '请填写参数键名', trigger: 'blur' }
        ],
        configValue:[
            { required: true, message: '请填写参数键值', trigger: 'blur' }
        ],
        remark:[
