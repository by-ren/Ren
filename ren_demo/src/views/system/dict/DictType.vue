<template>
		...
		<el-table-column fixed="right" label="操作" min-width="120">
			<template #default="scope">
				<el-button
					...
					type="primary"
					size="small"
					@click="openModifyDictTypeDialog(scope.$index, scope.row)"
					>修改</el-button
				>
				<el-button
					link
	...
	>
		...
		>
			<el-form-item
				label="字典名称"
				:label-width="addOrModifyDictTypeFormLabelWidth"
				prop="dictName"
			>
		...
		<template #footer>
			<span class="dialog-footer">
				...
				<el-button
					type="primary"
					@click="addOrModifyDictTypeConfirm(addOrModifyDictTypeFormRef)"
				>
					确 定
				</el-button>
			</span>
