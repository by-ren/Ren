<template>
      ...
      <div class="cache-content">
        ...
        <el-card class="panel-container cache-list">
          <div class="panel-header">
            <h3 class="panel-title" style="display: flex;justify-content: flex-start;align-items: center;">
              <el-icon :size="20" style="cursor: pointer;margin-right: 10px;"><i-ep-collection /></el-icon>
              缓存列表
            </h3>
            <div class="panel-actions">
              <div style="display: flex;justify-content: start;align-items: center;">
                <el-tooltip content="刷新缓存列表" placement="top" >
                  <el-icon :size="20" style="cursor: pointer;margin-right: 10px;" @click="refreshCacheList"><i-ep-refresh /></el-icon>
                </el-tooltip>
                <el-tooltip content="清空缓存列表" placement="top" >
                  <el-icon :size="20" style="cursor: pointer;" @click="cleanCacheListHandler"><i-ep-close /></el-icon>
                </el-tooltip>
              </div>
            </div>
          </div>
            ...
            <el-table-column label="操作" width="100" >
              <template #default="{ row }">
                ...
                <el-tooltip content="删除" placement="top" >
                  <el-icon :size="20" style="cursor: pointer;" @click.stop="deleteCacheHandler(row)"><i-ep-delete /></el-icon>
                </el-tooltip>
                </div>
              </template>
            </el-table-column>
        ...
        <el-card class="panel-container key-list">
          <div class="panel-header">
            <h3 class="panel-title" style="display: flex;justify-content: flex-start;align-items: center;">
              <el-icon :size="20" style="cursor: pointer;margin-right: 10px;"><i-ep-key /></el-icon>
              键名列表
            </h3>
            <div class="panel-actions">
              <div style="display: flex;justify-content: start;align-items: center;">
              <el-tooltip content="刷新键值列表" placement="top" >
                <el-icon :size="20" style="cursor: pointer;" @click="refreshKeys"><i-ep-refresh /></el-icon>
              </el-tooltip>
              </div>
            </div>
          </div>
          <el-table
            ...
            <el-table-column label="操作" width="80">
              <template #default="{ row }">
                <div style="display: flex;justify-content: start;align-items: center;">
                <el-tooltip content="删除" placement="top" >
                  <el-icon :size="20" style="cursor: pointer;" @click.stop="deleteKeyHandler(row)"><i-ep-delete /></el-icon>
                </el-tooltip>
                </div>
              </template>
            </el-table-column>
        ...
        <el-card class="panel-container cache-detail">
          <div class="panel-header">
            <h3 class="panel-title" style="display: flex;justify-content: flex-start;align-items: center;">
              <el-icon :size="20" style="cursor: pointer;margin-right: 10px;"><i-ep-document /></el-icon>
              缓存详情
            </h3>
            <div class="panel-actions">
              <div style="display: flex;justify-content: start;align-items: center;">
                <el-tooltip content="复制" placement="top" >
                  <el-icon :size="20" style="cursor: pointer;" @click="copyCacheContent"><i-ep-copydocument /></el-icon>
                </el-tooltip>
              </div>
            </div>
          </div>
  ...
  import { ref } from 'vue';
  import {listCache,listKey,deleteCache,deleteKey,cleanCacheList} from '@/api/monitor/cache/list'
  ...
  const copyCacheContent = () => {
    navigator.clipboard.writeText(selectedKey.value.value)
      .then(() => {
