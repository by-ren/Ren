...
INSERT INTO `sys_config` VALUES (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 1, 'admin', 1747626140, '', NULL, '初始化密码 123456');
...
-- ----------------------------
INSERT INTO `sys_dict_data` VALUES (1, 1, '男', '0', 'sys_user_sex', '', '', 1, 0, 'admin', 1747626140, '', NULL, '性别男');
INSERT INTO `sys_dict_data` VALUES (2, 2, '女', '1', 'sys_user_sex', '', '', 0, 0, 'admin', 1747626140, '', NULL, '性别女');
INSERT INTO `sys_dict_data` VALUES (3, 3, '未知', '2', 'sys_user_sex', '', '', 0, 0, 'admin', 1747626140, '', NULL, '性别未知');
INSERT INTO `sys_dict_data` VALUES (4, 1, '显示', '0', 'sys_show_hide', '', 'primary', 1, 0, 'admin', 1747626140, '', NULL, '显示菜单');
INSERT INTO `sys_dict_data` VALUES (5, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '隐藏菜单');
INSERT INTO `sys_dict_data` VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 1, 0, 'admin', 1747626140, '', NULL, '正常状态');
INSERT INTO `sys_dict_data` VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '停用状态');
INSERT INTO `sys_dict_data` VALUES (8, 1, '正常', '0', 'sys_job_status', '', 'primary', 1, 0, 'admin', 1747626140, '', NULL, '正常状态');
INSERT INTO `sys_dict_data` VALUES (9, 2, '暂停', '1', 'sys_job_status', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '停用状态');
INSERT INTO `sys_dict_data` VALUES (10, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 1, 0, 'admin', 1747626140, '', NULL, '默认分组');
INSERT INTO `sys_dict_data` VALUES (11, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 0, 0, 'admin', 1747626140, '', NULL, '系统分组');
INSERT INTO `sys_dict_data` VALUES (12, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 1, 0, 'admin', 1747626140, '', NULL, '系统默认是');
INSERT INTO `sys_dict_data` VALUES (13, 2, '否', 'N', 'sys_yes_no', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '系统默认否');
INSERT INTO `sys_dict_data` VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 1, 0, 'admin', 1747626140, '', NULL, '通知');
INSERT INTO `sys_dict_data` VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 0, 0, 'admin', 1747626140, '', NULL, '公告');
INSERT INTO `sys_dict_data` VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 1, 0, 'admin', 1747626140, '', NULL, '正常状态');
INSERT INTO `sys_dict_data` VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '关闭状态');
INSERT INTO `sys_dict_data` VALUES (18, 99, '其他', '0', 'sys_oper_type', '', 'info', 0, 0, 'admin', 1747626140, '', NULL, '其他操作');
INSERT INTO `sys_dict_data` VALUES (19, 1, '新增', '1', 'sys_oper_type', '', 'info', 0, 0, 'admin', 1747626140, '', NULL, '新增操作');
INSERT INTO `sys_dict_data` VALUES (20, 2, '修改', '2', 'sys_oper_type', '', 'info', 0, 0, 'admin', 1747626140, '', NULL, '修改操作');
INSERT INTO `sys_dict_data` VALUES (21, 3, '删除', '3', 'sys_oper_type', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '删除操作');
INSERT INTO `sys_dict_data` VALUES (22, 4, '授权', '4', 'sys_oper_type', '', 'primary', 0, 0, 'admin', 1747626140, '', NULL, '授权操作');
INSERT INTO `sys_dict_data` VALUES (23, 5, '导出', '5', 'sys_oper_type', '', 'warning', 0, 0, 'admin', 1747626140, '', NULL, '导出操作');
INSERT INTO `sys_dict_data` VALUES (24, 6, '导入', '6', 'sys_oper_type', '', 'warning', 0, 0, 'admin', 1747626140, '', NULL, '导入操作');
INSERT INTO `sys_dict_data` VALUES (25, 7, '强退', '7', 'sys_oper_type', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '强退操作');
INSERT INTO `sys_dict_data` VALUES (26, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 0, 0, 'admin', 1747626140, '', NULL, '生成操作');
INSERT INTO `sys_dict_data` VALUES (27, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '清空操作');
INSERT INTO `sys_dict_data` VALUES (28, 1, '成功', '0', 'sys_common_status', '', 'primary', 0, 0, 'admin', 1747626140, '', NULL, '正常状态');
INSERT INTO `sys_dict_data` VALUES (29, 2, '失败', '1', 'sys_common_status', '', 'danger', 0, 0, 'admin', 1747626140, '', NULL, '停用状态');
...
-- ----------------------------
INSERT INTO `sys_dict_type` VALUES (1, '用户性别', 'sys_user_sex', 0, 'admin', 1747626140, 'admin', 1747637935, '用户性别列表');
INSERT INTO `sys_dict_type` VALUES (2, '菜单状态', 'sys_show_hide', 0, 'admin', 1747626140, '', NULL, '菜单状态列表');
INSERT INTO `sys_dict_type` VALUES (3, '系统开关', 'sys_normal_disable', 0, 'admin', 1747626140, '', NULL, '系统开关列表');
INSERT INTO `sys_dict_type` VALUES (4, '任务状态', 'sys_job_status', 0, 'admin', 1747626140, '', NULL, '任务状态列表');
INSERT INTO `sys_dict_type` VALUES (5, '任务分组', 'sys_job_group', 0, 'admin', 1747626140, '', NULL, '任务分组列表');
INSERT INTO `sys_dict_type` VALUES (6, '系统是否', 'sys_yes_no', 0, 'admin', 1747626140, '', NULL, '系统是否列表');
INSERT INTO `sys_dict_type` VALUES (7, '通知类型', 'sys_notice_type', 0, 'admin', 1747626140, '', NULL, '通知类型列表');
INSERT INTO `sys_dict_type` VALUES (8, '通知状态', 'sys_notice_status', 0, 'admin', 1747626140, '', NULL, '通知状态列表');
INSERT INTO `sys_dict_type` VALUES (9, '操作类型', 'sys_oper_type', 0, 'admin', 1747626140, '', NULL, '操作类型列表');
INSERT INTO `sys_dict_type` VALUES (10, '系统状态', 'sys_common_status', 0, 'admin', 1747626140, '', NULL, '登录状态列表');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 1, '验证码错误', 1747626140);
INSERT INTO `sys_logininfor` VALUES (101, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (102, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (103, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (104, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '退出成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (105, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (106, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 1, '验证码错误', 1747626140);
INSERT INTO `sys_logininfor` VALUES (107, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 1, 'Cannot invoke \"org.springframework.security.core.Authentication.getName()\" because \"usernamePasswordAuthenticationToken\" is null', 1747626140);
INSERT INTO `sys_logininfor` VALUES (108, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
INSERT INTO `sys_logininfor` VALUES (109, 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 0, '登录成功', 1747626140);
...
INSERT INTO `sys_menu` VALUES (100, '用户管理', 1, 1, 'user', 'user', 'system/user/Index', '', 1, 0, 'C', 0, 0, 'system:user:list', 'i-ep-user', 'admin', 1745934956, 'admin', 1746866343, '用户管理菜单', 0);
INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 2, 'role', 'role', 'system/role/Index', '', 1, 0, 'C', 0, 0, 'system:role:list', 'i-ep-avatar', 'admin', 1745934956, 'admin', 1746866364, '角色管理菜单', 0);
INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 3, 'menu', 'menus', 'system/menus/Index', '', 1, 0, 'C', 0, 0, 'system:menu:list', 'i-ep-menu', 'admin', 1745934956, 'admin', 1746866374, '菜单管理菜单', 0);
INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 4, 'dept', 'dept', 'system/dept/Index', '', 1, 0, 'C', 0, 0, 'system:dept:list', 'i-ep-grid', 'admin', 1745934956, 'admin', 1746866466, '部门管理菜单', 0);
...
INSERT INTO `sys_menu` VALUES (500, '操作日志', 108, 1, 'operlog', 'operlog', 'system/operLog/Index', '', 1, 0, 'C', 0, 0, 'system:operlog:list', 'i-ep-platform', 'admin', 1745934956, 'admin', 1746866625, '操作日志菜单', 0);
INSERT INTO `sys_menu` VALUES (501, '登录日志', 108, 2, 'logininfor', 'logininfor', 'system/logininfor/Index', '', 1, 0, 'C', 0, 0, 'system:logininfor:list', 'i-ep-iphone', 'admin', 1745934956, 'admin', 1746866664, '登录日志菜单', 0);
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES (1, '温馨提醒：2018-07-01 若依新版本发布啦', 2, '新版本内容', 0, 'admin', 1747626140, '', NULL, '管理员');
INSERT INTO `sys_notice` VALUES (2, '维护通知：2018-07-01 若依系统凌晨维护', 1, '维护内容', 0, 'admin', 1747626140, '', NULL, '管理员');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '超级管理员', '{bcrypt}$2a$10$rbt2eZHv6R0MTBDGTnE87.3mKDgP3Zfi.ecvE/1J4mYItQJ6w2Dha', 0, 103, '00', 'ren@163.com', '18411111111', 0, '', '127.0.0.1', 1747647270, 'admin', 1745934956, 'admin', 1747647270, '超级管理员');
